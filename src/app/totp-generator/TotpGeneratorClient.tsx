    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
        ...
        <div className="card p-6 sm:p-8">
          <div className="mb-6 text-center">
            <h1 className="text-2xl sm:text-3xl font-bold">
              <span className="gradient-text">TOTP 2FA Authenticator Simulator</span>
            </h1>
            <p className="mt-2 text-sm text-text-secondary">
              Generate real-time RFC 6238 2FA security tokens directly from Base32 secret keys or otpauth:// URIs.
            </p>
          </div>
        ...
        <div className="hidden lg:block">
          <InfoPanel toolId="totp-generator" stats={stats} />
        </div>
      </div>
