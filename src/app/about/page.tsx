...
export const metadata: Metadata = {
  ...
  description:
    "Learn about MegaTools: 65+ fast, free, 100% in-browser developer, media, and cybersecurity tools running with zero server uploads.",
  openGraph: {
      ...
      <div className="card p-6 sm:p-10 space-y-8">
        <div>
          ...
          <p className="mt-3 text-base text-text-secondary leading-relaxed">
            MegaTools is an airgapped, privacy-first suite of 65+ free developer, media, and cybersecurity utilities engineered to run 100% inside your web browser.
          </p>
        </div>
